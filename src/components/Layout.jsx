...
const items = [
    ...
    getItem('Kategoriya', '3', <FileOutlined />, '/categories'),
    getItem('Attribut', '4', <FileOutlined />, '/attribute'),
    getItem('Brand', '5', <FileOutlined />, '/brand'),
    getItem('Banner', '6', <FileOutlined />, '/banner'),
    getItem('Buyurtmalar', '7', <FileOutlined />, '/orders'),
]
const MainLayout = () => {
